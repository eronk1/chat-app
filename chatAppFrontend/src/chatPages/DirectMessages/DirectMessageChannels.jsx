...
function DirectMessageChannels({userSummary,handleGetDirectMessage, selectedChannel, directChannels, groupChannels, username, currentActive}) {
    ...
    <div className={styles["direct-channels-parent-cags2"]}>
        ...
        <div ref={parentRef}>
            ...
            <UserSettingsParent userSummary={userSummary} />
    </div>
  )
}
...
function UserSettingsParent({userSummary}){
  ...
  return (
    <div className={styles['user-settings-svg-parent']}>
      ...
      >
          ...
          <div className={styles['direct-channel-box-name']}>{userSummary.username}</div>
      </div>
      <svg className={styles['user-settings-svg-icon']} fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 489.802 489.802" xmlSpace="preserve">
        <g>
